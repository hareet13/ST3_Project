...
public class floorservices {
	...
	/////////////////////////////////////////////////////method for button OK of floor edit Panel//////////////////////////
	public floormodels editidOk(floormodels fm){
		try{
			...
			if(!rs.isBeforeFirst()&&rs.getRow()==0){
				//JOptionPane.showMessageDialog(null, "NO floor Record is Available..!");
				fm.setFlag(0);
				return fm;
			}
			else{
		...
		return null;
	}/////end of floor edit botton ok method
	...
	Connection con=hstlconnection.getConnection();
		...
		public ComboBoxModel comboview(){
			try{
				...
				ResultSet rs=st.executeQuery("select distinct blokname from hstlblok order by 1");
		...
		////////////////////////////////////////////////////floor table details view method
	public TableModel florview(){
		try{
			...
			for(int colm=1;colm<=numcolms;colm++)colname.addElement(rmetad.getColumnLabel(colm));// getting colnames
