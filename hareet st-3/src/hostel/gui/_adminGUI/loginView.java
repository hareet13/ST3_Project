...
public class loginView extends JFrame {
	...
	public loginView() {
		...
		scrollPane_1.setViewportView(tb1.table);		// -- current table in Scroll panel
		scrollPane_1.setBounds(23, 11, 619, 99);
		contentPane.add(scrollPane_1);
		
		JButton btnNewButton = new JButton("Refresh Table");////////----------------refresh table
