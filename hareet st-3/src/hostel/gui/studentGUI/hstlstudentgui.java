package hostel.gui.studentGUI;

import hostel.hstlmodels.studentmodels; 
import hostel.hstlservices.studentservices;
...
public class hstlstudentgui extends JPanel {
	 ...
	 */
	 public hstlstudentgui() {
		...
		btnStudEdiOK.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try{
					...
					if(sm.getStdfflag()==1){
						hstlstdEditpanel edi=new hstlstdEditpanel();////display edit pane in tabbed panel
						edi.setStdValue(sm);
						tabp1StdEdit.addTab("Editor",null,edi,null);
					}
					else {
			    	//JOptionPane.showMessageDialog(null, "Entered Id is Not Valied....!");
		...
		//============================================CLEARING ENTERED FIELDS IN STUDENT ADD=======================
		...
		//============================================================================================================================
		////===================================================Submitting Button Student Details===========================================
		//===========================================================================================================
