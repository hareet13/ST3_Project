...
/////////=================================---------------------------------Add Visitor------------------------		
		     ...
		     btnVstaddSub.addActionListener(new ActionListener() {
		     	public void actionPerformed(ActionEvent arg0) {
		     		...
		     		SimpleDateFormat fmt=new SimpleDateFormat("hh:mm a");//--setting a time format.
		     		Date tm=new Date();
		     		tm=(Date)spinnTm1.getValue();
		     		 time1=fmt.format(tm);
		     		 vm.setVstEtme(time1);				//---entry time.

		     		Date tm1=new Date();
		     		tm1=(Date)spinnTm2.getValue();
		     		time1=fmt.format(tm1);
		     		//System.out.println("Entry time:  "+time1 );
		     	    vm.setVstLtme(time1);			//---Leaving time
