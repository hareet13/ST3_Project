...
public class hstlablcgui extends JPanel {
	...
	public hstlablcgui() {
		...
		AddRent.add(lblNewLabel_3);
													//////////////Edit Current Hostel Mess Fee
		chckbEditmessfee = new JCheckBox("Edit Current Mess Fee");
		chckbEditmessfee.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				//Syntax:=> JOptionPane.showMessageDialog (null, "Messagehere", "Title here", JOptionPane.PLAIN_MESSAGE); 
				//JOptionPane.showMessageDialog (null, "hello", "hello", JOptionPane.PLAIN_MESSAGE); 
				//JOptionPane.showMessageDialog (null, "hello", "hello", JOptionPane.ERROR_MESSAGE);
				//JOptionPane.showMessageDialog (null, "hello", "confirm", JOptionPane.INFORMATION_MESSAGE); 
		...
		JButton btnTotal = new JButton("Find Total");
		...
		JLabel lblNewLabel_13 = new JLabel("Rs.");
